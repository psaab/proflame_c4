...
| Connect Timeout | INTEGER | 30 | Connect-attempt watchdog (seconds); 0 disables. Forces teardown + reschedule if neither Established nor Offline arrives in time (issue #71) |
